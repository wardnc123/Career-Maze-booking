  ...
  return (
    <main className="min-h-screen bg-gray-50">
      <div className="max-w-3xl mx-auto px-4 py-6 sm:px-6">
        ...
        {/* Session Duration */}
        <section className="mb-6">
          <h3 className="text-lg font-semibold text-gray-800 mb-2">Session Duration (minutes)</h3>
          <input
            type="number"
            min="1"
          ...
          />
          <p className="text-xs text-gray-500 mt-1">Examples: 60 = 1 hour, 180 = 3 hours, 360 = 6 hours, 480 = full day</p>
        </section>

        {/* Slot Interval */}
        <section className="mb-6">
          <h3 className="text-lg font-semibold text-gray-800 mb-2">Slot Interval (minutes)</h3>
          <input
            type="number"
            min="1"
            value={slotInterval}
            ...
            className="border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 w-40"
          />
          <p className="text-xs text-gray-500 mt-1">Time between session start times.</p>
        </section>
